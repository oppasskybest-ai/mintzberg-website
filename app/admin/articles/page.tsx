...
export default function AdminArticles() {
  return (
    <ResourceManager
      ...
      fields={[
        { key: 'title', label: 'Title (used to generate the URL — required for new articles)', type: 'text' },
        { key: 'year', label: 'Year', type: 'text' },
        {
          key: 'order_index',
          label: 'Order (lower number shows first within its year)',
          type: 'number',
          helpText: 'Leave blank and this article goes to the top of its year group. Type a number to place it manually.',
        },
